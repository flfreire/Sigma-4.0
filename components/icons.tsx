...
export const UserGroupIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 015.908 0M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 015.908 0m-5.908 0a3.75 3.75 0 01-5.908 0m5.908 0a3.75 3.75 0 01-5.908 0M15 21a3 3 0 11-6 0 3 3 0 016 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.75a3 3 0 11-6 0 3 3 0 016 0zM19.5 3.75a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.267c-.317.027-.631.054-.946.081a6.744 6.744 0 01-3.198-.952 6.744 6.744 0 01-3.198.952c-.316-.027-.63-.054-.946-.081l-3.722-.267A2.25 2.25 0 012.25 15.5v-4.286c0-.97.616-1.813 1.5-2.097v-.658a2.25 2.25 0 012.25-2.25h3.518c.417 0 .82.164 1.12.458l2.12 1.897a.75.75 0 001.06 0l2.12-1.897a1.5 1.5 0 011.12-.458h3.518a2.25 2.25 0 012.25 2.25v.658z" />
    </svg>
);
...
export const TruckIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V14.25m-17.25 4.5v-9m17.25 9v-9m-17.25-9h9.563c.621 0 1.125.504 1.125 1.125v4.5m-10.688 0H18.75m-10.688 0L7.125 5.25m11.625 0L14.25 5.25" />
    </svg>
);

export const QrCodeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5a.75.75 0 00-.75.75v3.75c0 .414.336.75.75.75h3.75a.75.75 0 00.75-.75V5.25a.75.75 0 00-.75-.75H3.75zM3.75 15a.75.75 0 00-.75.75v3.75c0 .414.336.75.75.75h3.75a.75.75 0 00.75-.75V15.75a.75.75 0 00-.75-.75H3.75zM15 3.75a.75.75 0 00-.75.75v3.75c0 .414.336.75.75.75h3.75a.75.75 0 00.75-.75V4.5a.75.75 0 00-.75-.75H15zM16.5 15h.008v.008h-.008V15zm-3.75 0h.008v.008h-.008V15zm-3.75 0h.008v.008h-.008V15zm-3.75 3.75h.008v.008h-.008v-.008zm3.75 0h.008v.008h-.008v-.008zm3.75 0h.008v.008h-.008v-.008zm3.75 0h.008v.008h-.008v-.008zm-15-7.5h.008v.008H4.5v-.008zm3.75 0h.008v.008h-.008v-.008zm7.5 0h.008v.008h-.008v-.008zm3.75 0h.008v.008h-.008v-.008zM15 15h.008v.008h-.008V15zm3.75 0h.008v.008h-.008V15z" />
    </svg>
);
